...
public class PermissionServiceImpl implements PermissionService {
	private List<String> permissionNames = List.of("get_all_users", "get_department_users", "get_own_info",
			...
			"delete_any_user", "employee.read", "employee.create", "employee.update", "employee.delete",
			"employee.department.read", "employee.position.read", "role.readAll", "role.readRoleByID", "role.create",
			"role.updateRoleByID", "role.deleteRoleByID");
