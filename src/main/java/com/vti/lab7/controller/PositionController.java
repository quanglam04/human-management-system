...
public class PositionController {
	...
	public ResponseEntity<RestData<PositionDTO>> getPositionByID(@PathVariable long id) throws NotFoundException, MethodArgumentTypeMismatchException{
    ...
    public ResponseEntity<RestData<Void>> deletePosition(@PathVariable Long id) throws NotFoundException, MethodArgumentTypeMismatchException {
		Position position = positionServiceImpl.findById(id);
		if(position == null)
			throw new NotFoundException("Id invalid");
    ...
    public ResponseEntity<RestData<PositionDTO>> updatePosition(@PathVariable Long id,@Valid @RequestBody PositionRequestDTO request) throws NotFoundException,MethodArgumentTypeMismatchException {
    	Position position = positionServiceImpl.findById(id);
		if(position == null)
			throw new NotFoundException("Id invalid");
